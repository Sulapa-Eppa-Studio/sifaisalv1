...
class PaymentHeatmapChart extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static ?string $chartId = 'paymentHeatmapChart';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'PaymentHeatmapChart';
